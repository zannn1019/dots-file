...
Item {
    ...
    function initRopes() {
        ...
        for (var i = 0; i < 4; i++) {
            ...
            for (var j = 0; j <= root.ropeSegments; j++) {
                rope.nodes.push({ x: 0, y: 0, ox: 0, oy: 0 })
            }
            r.push(rope)
        }
        root.ropes = r
    ...
    function getRopeEndpoints(index) {
        ...
        switch(index) {
            case 0: return { x1: sx, y1: sy, x2: 0, y2: 0 }
            case 1: return { x1: sx + sw, y1: sy, x2: pw, y2: 0 }
            case 2: return { x1: sx, y1: sy + sh, x2: 0, y2: ph }
            case 3: return { x1: sx + sw, y1: sy + sh, x2: pw, y2: ph }
        }
    ...
    Timer {
        ...
        running: true
        onTriggered: {
            if (!root.initialized) root.initRopes()
            root.simulate()
    ...
    Canvas {
        ...
        onPaint: {
            ...
            if (!root.initialized || root.ropes.length < 4) return
    ...
    Rectangle {
        z: 3; width: root.handleSize; height: root.handleSize; radius: root.handleSize / 2
        color: root.handleColor
        x: root.regionX - root.handleSize / 2; y: root.regionY - root.handleSize / 2
    }
    Rectangle {
        z: 3; width: root.handleSize; height: root.handleSize; radius: root.handleSize / 2
        color: root.handleColor
        x: root.regionX + root.regionWidth - root.handleSize / 2; y: root.regionY - root.handleSize / 2
    }
    Rectangle {
        z: 3; width: root.handleSize; height: root.handleSize; radius: root.handleSize / 2
        color: root.handleColor
        x: root.regionX - root.handleSize / 2; y: root.regionY + root.regionHeight - root.handleSize / 2
    }
    Rectangle {
        z: 3; width: root.handleSize; height: root.handleSize; radius: root.handleSize / 2
        color: root.handleColor
        x: root.regionX + root.regionWidth - root.handleSize / 2; y: root.regionY + root.regionHeight - root.handleSize / 2
    }
    Rectangle {
        z: 3; width: root.handleSize; height: root.handleSize; radius: root.handleSize / 2
        color: root.handleColor
        x: root.regionX + root.regionWidth / 2 - root.handleSize / 2; y: root.regionY - root.handleSize / 2
    }
    Rectangle {
        z: 3; width: root.handleSize; height: root.handleSize; radius: root.handleSize / 2
        color: root.handleColor
        x: root.regionX + root.regionWidth / 2 - root.handleSize / 2; y: root.regionY + root.regionHeight - root.handleSize / 2
    }
    Rectangle {
        z: 3; width: root.handleSize; height: root.handleSize; radius: root.handleSize / 2
        color: root.handleColor
        x: root.regionX - root.handleSize / 2; y: root.regionY + root.regionHeight / 2 - root.handleSize / 2
    }
    Rectangle {
        z: 3; width: root.handleSize; height: root.handleSize; radius: root.handleSize / 2
        color: root.handleColor
        x: root.regionX + root.regionWidth - root.handleSize / 2; y: root.regionY + root.regionHeight / 2 - root.handleSize / 2
    }
